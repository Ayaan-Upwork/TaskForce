...
@section('content')
    <div class="row card">
        <div class="card-header">
            ...
            <!--</div>-->
            <form action="{{ url('roasters/reportViaDate') }}">
                <div class="row">
                    <div class="col-md-2">
                ...
                <tbody>
                    @foreach ($employees as $employee)
                        <tr>
                            ...
                            <td>{{ $employee->days }}</td>
                            <td>{{ $employee->time }}</td>
                            {{-- <td><a href="{{ url('roasterpersonal/reportViaDatePersonal' . $employee->id) }}"
                                    class="btn btn-primary">show</a> --}}
                            <td><a href="{{ url('show-roaster-by-employee/' . $employee->id) }}"
                                    class="btn btn-primary">show</a>
                            </td>
                        </tr>
                    @endforeach
